                ...
                flex flex-col items-start '>
                    ...
                    <React.Fragment>
                        ...
                        <div className='flex items-center justify-center h-screen'>
                            ...
                            <h2 className='text-lg font-bold mb-4'>Roll the Fun</h2>
                                <p className='text-center mb-4 font-serif'>Dive into the Dice Game Excitement, Where Every Throw Sparks Joy, and Your Gaming Adventure Begins with Unmatched Thrills!</p>
                                
                                <button className='text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-600 dark:hover:bg-gray-500 focus:outline-none dark:focus:ring-gray-500 '
